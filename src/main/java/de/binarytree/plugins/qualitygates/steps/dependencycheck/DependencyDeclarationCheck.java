...
public class DependencyDeclarationCheck extends DependencyCheck {
    ...
    public static final Logger LOGGER = Logger
            .getLogger(DependencyDeclarationCheck.class.toString());
    ...
    @Override
    protected void processBuildLog(AbstractBuild<?, ?> build,
    ...
    /**
     * Hook for the actual analysis of the dependency section
     * 
     * @param dependencySection
     *            the string which shall be analysed and should contain
     *            dependency information generated by maven
     * @return a result of the dependency analysis
     * @throws IOException when the log file could not be accessed or read
     */
    protected MavenDependencyAnalysisResult analyseDependencySection(
            String dependencySection) throws IOException {
